    ...
    <div className="p-6 space-y-4">
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <h1 className="text-xl font-semibold text-neutral-100">Resource Bookings</h1>
          <p className="text-sm text-neutral-500">Time-slot booking of shared resources with overlap validation.</p>
        </div>
