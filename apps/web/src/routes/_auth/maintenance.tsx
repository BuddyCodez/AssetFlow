    ...
    <div className="p-6 space-y-4">
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <h1 className="text-xl font-semibold text-neutral-100">Maintenance Management</h1>
          <p className="text-sm text-neutral-500">Route repairs through approval workflows before work begins.</p>
        </div>
