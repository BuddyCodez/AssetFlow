...
export const Route = createFileRoute('/_auth/allocations')({
    ...
    <div className="p-6 space-y-4">
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <h1 className="text-xl font-semibold text-neutral-100">Asset Allocations & Transfers</h1>
          <p className="text-sm text-neutral-500">Allocate assets to employees and departments with conflict prevention.</p>
        </div>
